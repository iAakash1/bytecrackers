...
} from "../../../../../../../../@chainlink/contracts/src/v0.8/functions/v1_0_0/interfaces/IFunctionsRouter";
...
export class IFunctionsRouter__factory {
  ...
  static createInterface(): IFunctionsRouterInterface {
    return new Interface(_abi) as IFunctionsRouterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IFunctionsRouter {
    return new Contract(address, _abi, runner) as unknown as IFunctionsRouter;
  }
}
