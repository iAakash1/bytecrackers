...
var ICONS = {
  add: async () => (await import("./add-SGQDS2RS.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-43TOW5LQ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-IML2GELH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-EXA3T74U.js")).appStoreSvg,
  apple: async () => (await import("./apple-NDIK5YY5.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-VJ2B7W46.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-EFP572UK.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-PAHI34R3.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-R7IERKD7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-7UN44Q53.js")).bankSvg,
  browser: async () => (await import("./browser-TNK6M567.js")).browserSvg,
  card: async () => (await import("./card-PR6IQ5A7.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-S5OJX45X.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-FVTOES6S.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-ITYLUH2O.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-YMJDW7JH.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-CILAHVNN.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-PLXHABEX.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-ET56D22N.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-MZRTJLYJ.js")).clockSvg,
  close: async () => (await import("./close-DRCSBHTH.js")).closeSvg,
  compass: async () => (await import("./compass-LSSEKAYI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-BQOAVHPM.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-UY36JFPM.js")).copySvg,
  cursor: async () => (await import("./cursor-64IY5N3N.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-WO62Y6MI.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-GKJIHT77.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-5JAQKI2V.js")).disconnectSvg,
  discord: async () => (await import("./discord-3SUURDHS.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-FIKMSYFO.js")).etherscanSvg,
  extension: async () => (await import("./extension-BYHEKQC5.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-EN73VOO2.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HRJRK3R3.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-MER5CYCS.js")).farcasterSvg,
  filters: async () => (await import("./filters-V3UUNBJN.js")).filtersSvg,
  github: async () => (await import("./github-VOT4QNQY.js")).githubSvg,
  google: async () => (await import("./google-E7DYFQZG.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-47VZMWXY.js")).helpCircleSvg,
  image: async () => (await import("./image-UNFX6NKT.js")).imageSvg,
  id: async () => (await import("./id-RYMT4C7Y.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-M73DMIZS.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-3HR6FHDH.js")).lightbulbSvg,
  mail: async () => (await import("./mail-J3ZX2G7P.js")).mailSvg,
  mobile: async () => (await import("./mobile-ZPIY5HBL.js")).mobileSvg,
  more: async () => (await import("./more-YOPWGBOF.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-7WXTXW3V.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-TUBTG4Z4.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-UHXGNGJP.js")).offSvg,
  playStore: async () => (await import("./play-store-5S3CMJX4.js")).playStoreSvg,
  plus: async () => (await import("./plus-R4SCLLTV.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-CM7KZMJR.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-EGZGCXCC.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-GPF7BDNE.js")).refreshSvg,
  search: async () => (await import("./search-WAXBZRCX.js")).searchSvg,
  send: async () => (await import("./send-QL2K2NX3.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-BKS6QZXM.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-NQ5MXVAM.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-4VZ47FK3.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-6N6GUSHS.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-IRUFDVLD.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-4R3QTPJ7.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-SEGAN47L.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-56FJ3IG7.js")).twitchSvg,
  twitter: async () => (await import("./x-BFKRVG2S.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-EDPHA2KV.js")).twitterIconSvg,
  verify: async () => (await import("./verify-VETBTK7X.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-CJ4BZE74.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-L33KOXBY.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ZBOYMN2X.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ZBOYMN2X.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ZBOYMN2X.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-MQBNMDR7.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-WT5SO5VZ.js")).warningCircleSvg,
  x: async () => (await import("./x-BFKRVG2S.js")).xSvg,
  info: async () => (await import("./info-PWOAYLOT.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-ZAMMPRI7.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-QQZ4TU52.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XP7TJXJ5.js.map
