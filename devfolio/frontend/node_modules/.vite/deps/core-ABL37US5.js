...
import {
  ...
  toString,
  y
} from "./chunk-5IQ36YFH.js";
import "./chunk-4IB5KCRL.js";
import "./chunk-ZEV5Y7YN.js";
...
import {
  ...
  numberToHex,
  toHex as toHex2
} from "./chunk-RFT3NGAV.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-AKZ6HF36.js";
import "./chunk-LWRGI3MQ.js";
import {
  require_events
} from "./chunk-IPN23N5B.js";
import "./chunk-4AHE63TL.js";
import "./chunk-ZFKU2BRN.js";
import "./chunk-UMKH2WVQ.js";
import "./chunk-ZVAP3WEV.js";
import "./chunk-THVDVUDB.js";
import "./chunk-NOXVN4LR.js";
import "./chunk-L4X2VTH5.js";
import {
  toHex
} from "./chunk-XSXRPSX4.js";
...
function Ic(t) {
  ...
  function j3(g, w2, b4, I3 = U4) {
    ...
    C5 && (w2 = e.hash(w2));
    const { r: Z2, s: st2 } = D3, W3 = B3(w2), J3 = c4(st2), Be4 = s(W3 * J3), zt3 = s(Z2 * J3), vt2 = a2.BASE.multiplyAndAddUnsafe(z3, Be4, zt3)?.toAffine();
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      if (Fc(a2)) return Dc(c4, o2?.encoding);
      if (Kc(a2)) {
      ...
      return Vc({ type: l4, symKey: h4, message: c4, senderPublicKey: d3, encoding: o2?.encoding });
    }), S2(this, "decode", async (s, n2, o2) => {
      this.isInitialized();
      const a2 = qc(n2, o2);
      if (Fc(a2)) {
        const c4 = Hc(n2, o2?.encoding);
      ...
      try {
        const c4 = this.getSymKey(s), h4 = Mc({ symKey: c4, encoded: n2, encoding: o2?.encoding });
...
var qn = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i3, s, n2) => {
      ...
      const a2 = n2?.ttl || je2, c4 = Zc(n2), h4 = n2?.prompt || false, l4 = n2?.tag || 0, d3 = n2?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s, opts: { ttl: a2, relay: c4, prompt: h4, tag: l4, id: d3, attestation: n2?.attestation, tvf: n2?.tvf } }, _2 = `Failed to publish payload, please try again. id:${d3} tag:${l4}`;
      try {
        const u3 = new Promise(async (b4) => {
          ...
          const I3 = yi(new Promise((D3, j3) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l4, id: d3, attestation: n2?.attestation, tvf: n2?.tvf }).then(D3).catch((T2) => {
...
var Li2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s = jc(), n2 = await this.core.crypto.setSymKey(s), o2 = Ei(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c4 = { topic: n2, expiry: o2, relay: a2, active: false, methods: i3?.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n2, symKey: s, relay: a2, expiryTimestamp: o2, methods: i3?.methods });
      return this.events.emit(re2.create, c4), this.core.expirer.set(n2, o2), await this.pairings.set(n2, c4), await this.core.relayer.subscribe(n2, { transportType: i3?.transportType }), { topic: n2, uri: h4 };
...
var Ui2 = class extends M {
  constructor(e, t, i3) {
    super(e, t, i3), this.core = e, this.logger = t, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      if (!o2) return;
      const c4 = this.getVerifyUrl(s?.verifyUrl);
  ...
  constructor(n2) {
    super(n2), c3(this, "name", dt2), c3(this, "events", new import_events4.default()), c3(this, "initialized", false), c3(this, "requestQueue", { state: $2.idle, queue: [] }), c3(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c3(this, "requestQueueDelay", import_time3.ONE_SECOND), c3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c3(this, "recentlyDeletedLimit", 200), c3(this, "relayMessageCache", []), c3(this, "pendingSessions", /* @__PURE__ */ new Map()), c3(this, "init", async () => {
      ...
      try {
        ...
        this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), l4?.setError(Y2.proposal_listener_not_found)), this.isValidConnect(v3({}, s.params));
        ...
        l4?.addTrace(G2.emit_session_proposal), this.client.events.emit("session_proposal", { id: a2, params: h4, verifyContext: u3 });
      } catch (l4) {
      ...
      return !e || t !== Q.link_mode ? false : ((i3 = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : i3.linkMode) === true && ((o2 = (r2 = this.client.metadata) == null ? void 0 : r2.redirect) == null ? void 0 : o2.universal) !== void 0 && ((l4 = (a2 = this.client.metadata) == null ? void 0 : a2.redirect) == null ? void 0 : l4.universal) !== "" && ((p3 = e?.redirect) == null ? void 0 : p3.universal) !== void 0 && ((h4 = e?.redirect) == null ? void 0 : h4.universal) !== "" && ((u3 = e?.redirect) == null ? void 0 : u3.linkMode) === true && this.client.core.linkModeSupportedApps.includes(e.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
...
function se3(s, t) {
  return te2(s, (e, i3, n2, a2) => {
    ...
    if (typeof s == "object") switch (Object.prototype.toString.call(s)) {
      ...
      case at2:
      case ot2: {
        const c4 = new s.constructor(s?.valueOf());
        return y5(c4, s), c4;
      }
      case ht3: {
        const c4 = {};
...
var AppKitBaseClient = class {
  constructor(options) {
    ...
    this.getCaipNetwork = (chainNamespace, id) => {
      if (chainNamespace) {
        const caipNetworkWithId = ChainController.getNetworkData(chainNamespace)?.requestedCaipNetworks?.find((c4) => c4.id === id);
        ...
        return requestedCaipNetworks.filter((c4) => c4.chainNamespace === chainNamespace)?.[0];
      }
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-B64MF46E.js");
      await import("./w3m-modal-QTRW3DJN.js");
...
*/
//# sourceMappingURL=core-ABL37US5.js.map
