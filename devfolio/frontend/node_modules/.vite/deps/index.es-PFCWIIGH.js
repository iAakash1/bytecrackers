...
function Ic(t) {
  ...
  function j4(g, w3, b5, I4 = U5) {
    ...
    C6 && (w3 = e.hash(w3));
    const { r: Z3, s: st3 } = D4, W4 = B4(w3), J4 = c4(st3), Be4 = s(W4 * J4), zt3 = s(Z3 * J4), vt2 = a2.BASE.multiplyAndAddUnsafe(z4, Be4, zt3)?.toAffine();
...
var qn = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i3, s, n2) => {
      ...
      const a2 = n2?.ttl || je2, c4 = Zc(n2), h4 = n2?.prompt || false, l4 = n2?.tag || 0, d3 = n2?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s, opts: { ttl: a2, relay: c4, prompt: h4, tag: l4, id: d3, attestation: n2?.attestation, tvf: n2?.tvf } }, _3 = `Failed to publish payload, please try again. id:${d3} tag:${l4}`;
      try {
        const u3 = new Promise(async (b5) => {
          ...
          const I4 = yi(new Promise((D4, j4) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l4, id: d3, attestation: n2?.attestation, tvf: n2?.tvf }).then(D4).catch((T3) => {
          ...
          try {
            ...
            this.queue.set(d3, Ge2(Ie2({}, g), { attempt: 1 })), this.logger.warn(D4, D4?.message);
          }
        });
...
var D3 = async () => {
  const { createAppKit: s } = await import("./core-ABL37US5.js");
  return s;
};
...
function G3(s) {
  ...
  const c4 = { chains: t, methods: n2 || f6, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l4 = a2?.filter((d3) => !C5.includes(d3)), r2 = n2?.filter((d3) => !f6.includes(d3));
  if (!e && !o2 && !i3 && !(l4 != null && l4.length) && !(r2 != null && r2.length)) return { required: t.length ? c4 : void 0 };
  const m2 = l4?.length && r2?.length || !e, h4 = { chains: [...new Set(m2 ? c4.chains.concat(e || []) : e)], methods: [...new Set(c4.methods.concat(i3 != null && i3.length ? i3 : A4))], events: [...new Set(c4.events.concat(o2 != null && o2.length ? o2 : P3))], rpcMap: u3 };
...
var b4 = class _b {
  ...
  getRpcConfig(t) {
    ...
    const u3 = i3.length ? t?.methods || f6 : [], c4 = i3.length ? t?.events || C5 : [], l4 = t?.optionalMethods || [], r2 = t?.optionalEvents || [], m2 = t?.rpcMap || this.buildRpcMap(o2, t.projectId), h4 = t?.qrModalOptions || void 0;
    return { chains: i3?.map((d3) => this.formatChainId(d3)), optionalChains: a2.map((d3) => this.formatChainId(d3)), methods: u3, events: c4, optionalMethods: l4, optionalEvents: r2, rpcMap: m2, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: h4, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, e) {
    const n2 = {};
    return t.forEach((i3) => {
...
*/
//# sourceMappingURL=index.es-PFCWIIGH.js.map
