import{w as pe,p as me,s as he,q as ve,M as g,t as ee,R as l,i as v,r as E,a as f,x as a,u as j,e as te,o as ie,h as m,d as H,j as fe,v as k,E as G,O as T,C as M,y as F,k as $,A as D,T as ge,z as be,b as ye,g as xe}from"./core-Dod9g0vj.js";import{c as u,n as d,r as w,o as V,U as Ce}from"./index-D18Sa5FC.js";import"./web3-DGCk60S9.js";import"./vendor-DBnw6Ey0.js";import"./index.es-RNN7Moso.js";const p=me({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return ve(p,()=>n(p))},subscribeKey(n,e){return he(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
...
//# sourceMappingURL=w3m-modal-QsU4H7pQ.js.map
